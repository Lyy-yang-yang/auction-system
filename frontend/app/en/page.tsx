...
export default function HomePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">🔥 Hot Auctions</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="p-4 flex flex-col flex-1">
              ...
              <div className="flex justify-between items-center text-sm text-gray-500">
                <span>Min Increment: ¥{product.min_bid_increment}</span>
                <span>Stock: {product.available_stock}/{product.total_stock}</span>
              </div>
              {product.status === 'active' ? (
                <div className="mt-3 text-green-600 text-sm">🔥 Active</div>
              ) : (
                <div className="mt-3 text-gray-400 text-sm">⏰ Ended</div>
              )}
            </div>
          </a>
        ))}
